...
python src/finetune_YOLO.py --data ${DATA_DIR}/configs/diffusion_bg20k_v3.yaml --epochs 25 --lr0 0.001 --freeze 20 --imgsz 960 --name diffusion_bg20k-only-20000 --project pace-v3-h2h-yolo-vid-shuf
