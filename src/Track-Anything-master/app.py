...
def select_template(image_selection_slider, video_state, interactive_state, mask_dropdown=False):
...
def generate_video_from_frames(frames, output_path, fps=30):
    ...
    # Convert frames to numpy array if it's not already
    ...
    print(f"Writing video: {output_path}, frames shape: {frames.shape}, fps: {fps}")
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            with gr.Row():
                ...
                with gr.Column():
                    ...
                    with gr.Row():
                        with gr.Row():
                            ...
                            clear_button_click = gr.Button(value="Clear clicks", interactive=True, visible=False) #, height=160
                ...
                with gr.Column():
                    run_status = gr.HighlightedText(value=[("Ready to start","Normal")], visible=False)
...
iface.launch(debug=True, server_port=args.port, server_name="0.0.0.0") # enable_queue=True,
