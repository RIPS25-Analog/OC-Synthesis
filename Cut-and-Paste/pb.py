...
if __name__ == "__main__":
    ...
    -----------------------------------------------------------------
    '''  
    img_mask = io.imread('Cut-and-Paste/test_images/IMG_4667_m.png', as_gray=True)
    img_src = io.imread('Cut-and-Paste/test_images/IMG_4667.png').astype(np.float64)
    img_target = io.imread('Cut-and-Paste/test_images/Untitled.png')
    
    # img_src = io.imread('./testimages/test1_src.png').astype(np.float64)
    # img_target = io.imread('./testimages/test1_target.png')
    # img_mask = io.imread('./testimages/test1_mask.png', as_gray=True)
    ...
    # img_mask = io.imread('/Users/ysakamoto/Desktop/mask.png', as_gray=True)
    ...
    plt.imshow(img_pro)
    plt.show()
    io.imsave('Cut-and-Paste/test_images/poisson_normal.png', img_pro)
